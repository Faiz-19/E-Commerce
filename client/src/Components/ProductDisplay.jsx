    ...
    <section className="flex flex-col lg:flex-row gap-8 lg:gap-12 w-full max-w-6xl mx-auto">
      <div className="flex flex-col-reverse md:flex-row gap-4 w-full lg:w-1/2">
        <div className="flex md:flex-col gap-2 justify-center">
          <img
            className="h-20 w-20 object-cover cursor-pointer border-2 border-transparent hover:border-red-500 rounded"
            src={product.image}
            alt=""
          />
          <img
      ...
      <div className="flex flex-col gap-5 w-full lg:w-1/2">
        ...
        <div className="flex gap-5 items-center">
          <p className="font-semibold text-zinc-500 line-through text-xl">
            ${product.old_price}
          </p>
        ...
        <div className="flex gap-3 flex-wrap">
          <button className="border border-zinc-200 bg-zinc-50 py-2 px-4 hover:bg-zinc-100 rounded">
            S
          </button>
          <button className="border border-zinc-200 bg-zinc-50 py-2 px-4 hover:bg-zinc-100 rounded">
            M
